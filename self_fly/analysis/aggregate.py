...
def load_run_summary(run_dir: Path) -> dict:
    ...
    return {
        ...
        "pi1_pre_reached": "pi_1_pre" in snapshot_trial_by_name,
        "pi1_pre_trial": snapshot_trial_by_name.get("pi_1_pre"),
        "pi1_reached": "pi_1_post" in snapshot_trial_by_name,
        "pi1_trial": snapshot_trial_by_name.get("pi_1_post"),
